...
abstract class Strings {
  ...
  static const LocalizationsDelegate<Strings> delegate = _StringDelegate();
...
class _StringDelegate extends LocalizationsDelegate<Strings>{
  const _StringDelegate();
